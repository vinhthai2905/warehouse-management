# Generated by Django 5.1.3 on 2025-06-07 15:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_nhan_vien_duyet', models.ForeignKey(db_column='id_nhan_vien_duyet', on_delete=django.db.models.deletion.CASCADE, related_name='yeu_cau_xuat_duyet', to='accounts.taikhoan')),
                ('id_nhan_vien_yc', models.ForeignKey(db_column='id_nhan_vien_yc', on_delete=django.db.models.deletion.CASCADE, related_name='yeu_cau_xuat_yc', to='accounts.taikhoan')),
            ],
            options={
