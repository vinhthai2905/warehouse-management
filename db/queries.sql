...
('YC006', 'SP001', 2, 'Demo laptop'),
('YC006', 'SP002', 5, 'Chuột không dây'),
('YC007', 'SP003', 1, 'Xuất bàn phím cơ'),
('YC007', 'SP004', 2, 'Màn hình hội thảo'),
('YC008', 'SP005', 3, 'Ổ cứng demo'),
('YC008', 'SP001', 1, 'Laptop kiểm thử'),
('YC009', 'SP002', 4, 'Chuột lỗi cần đổi'),
('YC009', 'SP003', 2, 'Xuất lỗi kỹ thuật'),
('YC010', 'SP004', 1, 'Màn hình hoàn trả'),
('YC010', 'SP005', 1, 'Ổ cứng hoàn trả'),
('YC011', 'SP001', 2, 'Laptop bảo hành'),
('YC011', 'SP002', 3, 'Chuột bảo hành'),
('YC012', 'SP003', 2, 'Kiểm thử layout'),
('YC012', 'SP004', 1, 'Màn hình kiểm tra'),
('YC013', 'SP005', 2, 'Bị từ chối đơn lỗi'),
('YC013', 'SP001', 1, 'Sai sản phẩm'),
('YC014', 'SP002', 5, 'Xuất gấp cho dự án'),
('YC014', 'SP003', 2, 'Bàn phím dự án'),
('YC015', 'SP004', 1, 'Tạm xuất thử nghiệm'),
('YC015', 'SP005', 3, 'Ổ cứng cho QA'),
('YC016', 'SP001', 2, 'Dự phòng hệ thống'),
('YC016', 'SP002', 1, 'Chuột dự phòng'),
('YC017', 'SP003', 2, 'Không đạt kiểm thử'),
('YC017', 'SP004', 1, 'Hỏng màn hình'),
('YC018', 'SP005', 2, 'Xuất nội bộ thử'),
('YC018', 'SP001', 1, 'Kiểm tra vận hành'),
('YC019', 'SP002', 4, 'Trưng bày sản phẩm'),
('YC019', 'SP003', 2, 'Dùng hội nghị'),
('YC020', 'SP004', 1, 'Giao khách mới'),
('YC020', 'SP005', 2, 'Ổ cứng khách mới');
